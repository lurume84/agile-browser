...
namespace AgileBrowser.Handlers
{
    /// <summary>
    ...
    public class RequestHandler : DefaultRequestHandler
    {
        ...
        public override void OnRenderProcessTerminated(IWebBrowser browserControl, IBrowser browser, CefTerminationStatus status)
        {
            ...
            browserControl.Load(AgileBrowser.RenderProcessCrashedUrl);
        }
        ...
        public override IResponseFilter GetResourceResponseFilter(IWebBrowser browserControl, IBrowser browser, IFrame frame, IRequest request, IResponse response)
        {
            ...
            if (url.Scheme == CefSharpSchemeHandlerFactory.SchemeName)
            {
                if(request.Url.Equals(AgileBrowser.ResponseFilterTestUrl, StringComparison.OrdinalIgnoreCase))
                {
